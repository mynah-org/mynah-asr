...
`PLAN.md`, `.work/*.md`, `docs/`, code. Untracked and private: the raw
evidence the notes summarise (`.work/evidence/`, `.work/private/`), profiler
dumps, benchmark artefact trees. Never `git add .work/` wholesale; before
